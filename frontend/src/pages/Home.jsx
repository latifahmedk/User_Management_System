...
function Home() {
  ...
  const getalldata= async()=>{
    try {
      const result = await axios.get("https://usermanagementsystem-k00s.onrender.com/user/all",{
  ...
  const deleteHandler= async(id)=>{
    try {
      await axios.delete(`https://usermanagementsystem-k00s.onrender.com/user/delete/${id}`,{withCredentials:true});
      getalldata();
    } catch (error) {
